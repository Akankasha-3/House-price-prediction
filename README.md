...
1. Clone the repository: `gh repo clone Akankasha-3/House-price-prediction`
...
3. Launch Google Colab: [Google Colab](https://colab.research.google.com/)
4. Open the `House_Price_Prediction.ipynb` file and run the notebook cells sequentially and make sure to connect the environment before running the code cells.
